...
module.exports = {
    siteUrl:
        process.env.NODE_ENV === `production`
            ? process.env.SITE_URL || config.siteUrl || `https://jocular-piroshki-906c28.netlify.app`
            : `https://jocular-piroshki-906c28.netlify.app`, // Site domain. Do not include a trailing slash!
